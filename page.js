...
(function (module, exports) {
  ...
  try {
    if (typeof window !== 'undefined' && typeof window.Buffer !== 'undefined') {
      ...
      Buffer = (__webpack_require__(/*! buffer */ "?e5a1").Buffer);
    }
  } catch (e) {
  }
...
/* harmony export */   "redirectIfPhishing": () => (/* binding */ redirectIfPhishing),
...
const hasBuffer = typeof _polkadot_x_global__WEBPACK_IMPORTED_MODULE_1__.xglobal.Buffer !== 'undefined';
...
/* harmony export */ });
/* harmony import */ var _bn_bn_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../bn/bn.js */ "../../node_modules/@polkadot/util/node_modules/bn.js/lib/bn.js");
// Copyright 2017-2022 @polkadot/util authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
/* harmony export */ });
/* harmony import */ var _polkadot_x_global__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @polkadot/x-global */ "../../node_modules/@polkadot/x-global/index.js");
...
const packageInfo = {
  ...
  path: ( true) ? new URL("file:///H:/github%20desktop/polkagate-extension/node_modules/@polkadot/x-bigint/packageInfo.js").pathname.substring(0, new URL("file:///H:/github%20desktop/polkagate-extension/node_modules/@polkadot/x-bigint/packageInfo.js").pathname.lastIndexOf('/') + 1) : 0,
  type: 'esm',
  version: '10.2.1'
};
...
const packageInfo = {
  ...
  path: ( true) ? new URL("file:///H:/github%20desktop/polkagate-extension/node_modules/@polkadot/x-textencoder/packageInfo.js").pathname.substring(0, new URL("file:///H:/github%20desktop/polkagate-extension/node_modules/@polkadot/x-textencoder/packageInfo.js").pathname.lastIndexOf('/') + 1) : 0,
  type: 'esm',
  version: '10.2.1'
};
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _polkadot_extension_base_defaults__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @polkadot/extension-base/defaults */ "../extension-base/src/defaults.ts");
/* harmony import */ var _polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @polkadot/extension-base/page */ "../extension-base/src/page/index.ts");
/* harmony import */ var _polkadot_extension_inject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @polkadot/extension-inject */ "../extension-inject/src/index.ts");
/* harmony import */ var _packageInfo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packageInfo */ "./src/packageInfo.ts");
// Copyright 2019-2023 @polkadot/extension authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
function inject() {
  (0,_polkadot_extension_inject__WEBPACK_IMPORTED_MODULE_0__.injectExtension)(_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_1__.enable, {
    name: 'polkagate',
    // added by polkagate
    version: _packageInfo__WEBPACK_IMPORTED_MODULE_2__.packageInfo.version
  });
...
window.addEventListener('message', ({
  ...
  if (source !== window || data.origin !== _polkadot_extension_base_defaults__WEBPACK_IMPORTED_MODULE_3__.MESSAGE_ORIGIN_CONTENT) {
    return;
  }

  if (data.id) {
    (0,_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_1__.handleResponse)(data);
  } else {
    console.error('Missing id for response.');
  }
});
(0,_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_1__.redirectIfPhishing)().then(gotRedirected => {
  if (!gotRedirected) {
    inject();
  }
}).catch(e => {
