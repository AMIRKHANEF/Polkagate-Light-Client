...
/***/ "../extension-polkagate/src/util/workers/needsPutInFrontOf.js":
/*!********************************************************************!*\
  !*** ../extension-polkagate/src/util/workers/needsPutInFrontOf.js ***!
  \********************************************************************/
...
async function needsPutInFrontOf(endpoint, target) {
  var _apiAt$query, _apiAt$query2;
  ...
  const renameConsistentApi = ((_apiAt$query = apiAt.query) == null ? void 0 : _apiAt$query.bagsList) || ((_apiAt$query2 = apiAt.query) == null ? void 0 : _apiAt$query2.voterList);
  ...
  while (lighterUnwrapped.isSome) {
    ...
    const mayLighterWeight = api.createType('Balance', (await apiAt.query.staking.ledger(mayLighterCtrl)).unwrapOrDefault().active); // console.log(` ${mayLighterCtrl}  : ${mayLighterWeight.toHuman()}`);

    if (mayLighterWeight.lt(targetWeight)) {
      return mayLighter == null ? void 0 : mayLighter.toHuman();
    }
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_polkadot_api_promise_Api_js"], () => (__webpack_require__("../extension-polkagate/src/util/workers/needsPutInFrontOf.js")))
...
/******/ 		var installedChunks = {
/******/ 			"extension-polkagate_src_util_workers_needsPutInFrontOf_js": 1
/******/ 		};
/******/ 		
