...
/***/ "../extension-polkagate/src/util/workers/getPoolStakingConsts.js":
/*!***********************************************************************!*\
  !*** ../extension-polkagate/src/util/workers/getPoolStakingConsts.js ***!
  \***********************************************************************/
...
async function getPoolStackingConsts(endpoint) {
  try {
    ...
    const ED = new _polkadot_util__WEBPACK_IMPORTED_MODULE_1__(api.consts.balances.existentialDeposit);
    const [maxPoolMembers, maxPoolMembersPerPool, maxPools, minCreateBond, minJoinBond, minNominatorBond, lastPoolId, currentEra, token] = await Promise.all([apiAt.query.nominationPools.maxPoolMembers(), apiAt.query.nominationPools.maxPoolMembersPerPool(), apiAt.query.nominationPools.maxPools(), apiAt.query.nominationPools.minCreateBond(), apiAt.query.nominationPools.minJoinBond(), apiAt.query.staking.minNominatorBond(), apiAt.query.nominationPools.lastPoolId(), api.query.staking.currentEra(), api.registry.chainTokens[0]]);
    return {
      eraIndex: Number(currentEra == null ? void 0 : currentEra.toString(), '0'),
      ...
      minCreationBond: (0,_polkadot_util__WEBPACK_IMPORTED_MODULE_2__.bnMax)(minCreateBond, ED, minNominatorBond).add(ED).toString(),
      // minimum that is needed in action
...
onmessage = e => {
  const {
    endpoint
  } = e.data; // eslint-disable-next-line @typescript-eslint/no-floating-promises
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_polkadot_api_promise_Api_js"], () => (__webpack_require__("../extension-polkagate/src/util/workers/getPoolStakingConsts.js")))
...
/******/ 		var installedChunks = {
/******/ 			"extension-polkagate_src_util_workers_getPoolStakingConsts_js": 1
/******/ 		};
/******/ 		
