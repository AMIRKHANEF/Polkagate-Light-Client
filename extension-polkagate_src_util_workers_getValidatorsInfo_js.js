...
/***/ "../extension-polkagate/src/util/workers/getValidatorsInfo.js":
/*!********************************************************************!*\
  !*** ../extension-polkagate/src/util/workers/getValidatorsInfo.js ***!
  \********************************************************************/
...
async function getAllValidators(endpoint) {
  ...
  try {
    ...
    const [elected, waiting, currentEra] = await Promise.all([api.derive.staking.electedInfo({
      withController: true,
    ...
    const nextElectedInfo = elected.info.filter(e => elected.nextElected.find(n => String(n) === String(e.accountId)));
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_polkadot_api_promise_Api_js"], () => (__webpack_require__("../extension-polkagate/src/util/workers/getValidatorsInfo.js")))
...
/******/ 		var installedChunks = {
/******/ 			"extension-polkagate_src_util_workers_getValidatorsInfo_js": 1
/******/ 		};
/******/ 		
