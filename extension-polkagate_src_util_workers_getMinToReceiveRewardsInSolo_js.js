...
/***/ "../extension-polkagate/src/util/workers/getMinToReceiveRewardsInSolo.js":
/*!*******************************************************************************!*\
  !*** ../extension-polkagate/src/util/workers/getMinToReceiveRewardsInSolo.js ***!
  \*******************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _polkadot_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @polkadot/util */ "../../node_modules/@polkadot/util/node_modules/bn.js/lib/bn.js");
...
async function getMinToReceiveRewardsInSolo(endpoint) {
  const api = await (0,_getApi__WEBPACK_IMPORTED_MODULE_0__["default"])(endpoint); // a map of all nominators
  ...
  stakers.map(x => x[1].others).flat().forEach(x => {
    ...
    const amount = new _polkadot_util__WEBPACK_IMPORTED_MODULE_1__(String(x.value));
  ...
  return {
    ...
    minToGetRewards: (0,_polkadot_util__WEBPACK_IMPORTED_MODULE_2__.bnMin)(...assignments.values()).toString(),
    token
  };
}
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_polkadot_api_promise_Api_js"], () => (__webpack_require__("../extension-polkagate/src/util/workers/getMinToReceiveRewardsInSolo.js")))
...
/******/ 		var installedChunks = {
/******/ 			"extension-polkagate_src_util_workers_getMinToReceiveRewardsInSolo_js": 1
/******/ 		};
/******/ 		
